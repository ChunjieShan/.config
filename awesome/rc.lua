...
awful.util.tagnames = { " DEV ", " TIM ", " WWW ", " DOC ", " DISK ", " VBOX ", " MUS ", " VID ", " PRX " }
...
local myawesomemenu = {
    ...
    { "edit config", terminal.." nvim /home/rick/.config/awesome/rc.lua" },
    { "arandr", "arandr" },
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Control" }, "e", function () awful.util.spawn( "$HOME/.config/awesome/scripts/dmenu/dmenu-edit-configs.sh" ) end,
        {description = "edit config files" , group = "dmenu scripts" }),
    awful.key({ altkey, "Control" }, "m", function () awful.util.spawn( "~/.config/awesome/scripts/dmenu/dmenu-sysmon.sh" ) end,
 ...
 --              {description = "show main menu", group = "launcher"}),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ modkey, "Shift"   }, "Return", function () awful.spawn(editorgui)           end,
    ...
    awful.key({ modkey, "Control"}, "q",  function () awful.spawn.with_shell( '~/.dmenu/prompt "are you sure?" "killall awesome"' ) end,
